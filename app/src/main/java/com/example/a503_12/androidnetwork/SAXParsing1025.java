...
public class SAXParsing1025 extends AppCompatActivity {
    ...
    class ThreadEX extends Thread{
        ...
        public void run() {
            ...
            try{
                //데이터 다운로드 받는 주소
                URL url = new URL("https://ph.sisain.co.kr/rss/1449643807.xml");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saxparsing1025);
        ...
        progressDialog = ProgressDialog.show(this,"시사인 문화","다운로드 중...");

        //하단으로 드래그 했을 때 수행할 이벤트 핸들
        swipe_layout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                progressDialog = ProgressDialog.show(SAXParsing1025.this,"시사인 문학", "업데이트 중");
                new ThreadEX().start();
            }
        });
        //스레드 시작
